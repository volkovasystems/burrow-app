echo System Architecture: 64-bit OS >> %USERPROFILE%\Documents\grid_downloads\install_log.txt
...
bitsadmin.exe /transfer "Download Nodejs x64" http://nodejs.org/dist/v0.10.30/x64/node-v0.10.30-x64.msi %USERPROFILE%\Documents\grid_downloads\node64_installer.msi
